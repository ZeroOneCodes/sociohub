  ...
  return (
    <div className="min-h-screen bg-gradient-to-br flex items-center justify-center p-4">
      <div className="w-full max-w-6xl rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 bg-gradient-to-br from-indigo-700 to-blue-300 p-8 flex flex-col justify-center items-center text-white">
          <div className="max-w-md text-center">
            ...
            <div className="relative w-full h-64">
              <div className="absolute inset-0 bg-[url('/login-illustration.svg')] bg-contain bg-no-repeat bg-center opacity-90"></div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full cursor-pointer flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 ${
