        ...
        <div className="md:w-1/2 p-10 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-white-500 mt-2">Enter your credentials to access your account</p>
            </div>
            ...
            <div className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link to="/signup" className="font-medium text-blue-600 hover:text-blue-800 transition duration-200">
                Sign up
              </Link>
            </div>
          </div>
